package com.soprasteria.academy.tp8;
...
public class TP8Lanceur {

	// chemin du fichier de configuration spring
	private static final String NOM_FICHIER_CONTEXTE = "com/soprasteria/academy/tp8/context/tp8.job.context.xml";
	...
	public static void main(String[] args) throws Exception {
		...
		// recuperation du job
		Job job = (Job)contexte.getBean("tp8JobID");
